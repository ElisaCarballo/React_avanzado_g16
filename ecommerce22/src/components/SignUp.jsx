      ...
      <div className='right-signin-section'>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className='form-signin'>
          ...
          <div className='form-goup'>
            <input
              type='text' placeholder='Nombre' className='form-input' {...register('nombre', {
                required: true
              })}
            />
          ...
          <div className='form-goup'>
            <input
              type='text' placeholder='Apellidos' className='form-input' {...register('apellidos', {
                required: true
              })}
            />
          ...
          <div className='form-goup'>
            ...
            <input
              type='date' placeholder='Fecha Nacimiento' className='form-input' {...register('nacimiento', {
                required: true
              })}
            />
          ...
          <div className='form-goup'>
            ...
            <input
              type='radio' name='genero' value='M' placeholder='Género' className='form-radio' {...register('genero', {
                required: true
              })}
            /> Masculino
            <input
              type='radio' name='genero' value='F' placeholder='Género' className='form-radio' {...register('genero', {
                required: true
              })}
            /> Femenino
            <input
              type='radio' name='genero' value='X' placeholder='Género' className='form-radio' {...register('genero', {
                required: true
              })}
            /> Otro
          ...
          <div className='form-goup'>
            <input
              type='text' placeholder='Correo' className='form-input' {...register('email', {
                required: true,
          ...
          <div className='form-goup'>
            <input
              type='password' placeholder='Contraseña' className='form-input' {...register('password', {
                required: true,
                minLength: 5
              })}
            />
